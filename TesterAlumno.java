...
public class TesterAlumno {
	...
	public static void main(String[] args) {
		Alumno a1 = new Alumno (12345678, "Pedro", "García Gómez", "C/ Delicias 34", 
				644444243, 10, 2, 2016);
		Alumno a2 = new Alumno (22233444, "Lucía", "Pérez Rodríguez", "Avda. Mediterráneo 67",
				655777372, 32, 5, 2016);	
		Alumno a3 = new Alumno (33344666, "Beatriz", "Sánchez Ríos", "Paseo de los Olivos 54", 
				688990011, 4, 13, 2015);
		...
		System.out.println("isValida <" + a1.getFechaMatricula().getFecha() + "> ? " + a1.isFechaValida(a1.getFechaMatricula()));
		System.out.println("isValida <" + a2.getFechaMatricula().getFecha() + "> ? " + a2.isFechaValida(a3.getFechaMatricula()));
		System.out.println("isValida <" + a3.getFechaMatricula().getFecha() + "> ? " + a3.isFechaValida(a3.getFechaMatricula()));
